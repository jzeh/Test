...
*/
//int HIGHT_CBC_Close( OUT KISA_HIGHT_INFO *pInfo, IN DWORD *out, IN int out_offset, IN int *outLen, unsigned int inLen, int pad );
...
*/
//int HIGHT_CBC_Decrypt( OUT BYTE *result, size_t *out_len, IN BYTE *pbszCipherText, IN int nCipherTextLen, IN BYTE *pbszUserKey, IN BYTE *pbszIV, int pad );
#ifdef  __cplusplus
}
#endif
