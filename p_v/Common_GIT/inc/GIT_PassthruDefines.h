...
#if defined(FCS_TEST)
#define MAX_PASSTHRUMSG_DATA_SIZE			1024
#else
#define MAX_PASSTHRUMSG_DATA_SIZE			4128
#endif

typedef __packed struct _stPASSTHRU_MSG
{
...
typedef __packed struct _stSBYTE_ARRAY
{
...
typedef __packed struct __stSPARAM
{
