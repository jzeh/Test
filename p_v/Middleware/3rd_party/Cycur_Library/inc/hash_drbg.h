 ...
 * has been adopted from the NIST example pseudo code (100000U).
 * We set it to the maximum, that means that 2^32 calls to GetRandom is allowed.
 **/
#    define EscHashDrbg_RESEED_INTERVAL 0xFFFFFFFFU
#endif
