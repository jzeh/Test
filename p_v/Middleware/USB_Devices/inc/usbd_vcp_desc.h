...
#ifndef __USB_VCP_DESC_H
#define __USB_VCP_DESC_H
...
/** @defgroup USBD_DESC_Exported_Variables
  * @{
  */
extern  uint8_t USBD_VCP_DeviceDesc  [USB_SIZ_DEVICE_DESC];
extern  uint8_t USBD_StrDesc[USB_MAX_STR_DESC_SIZ];
extern  uint8_t USBD_OtherSpeedCfgDesc[USB_LEN_CFG_DESC];
extern  uint8_t USBD_DeviceQualifierDesc[USB_LEN_DEV_QUALIFIER_DESC];
extern  uint8_t USBD_LangIDDesc[USB_SIZ_STRING_LANGID];
extern  USBD_DEVICE USR_VCP_desc;
...
uint8_t *     USBD_USR_VCP_USRStringDesc (uint8_t speed, uint8_t idx , uint16_t *length);
