...
#ifndef __USB_BULK_DESC_H
#define __USB_BULK_DESC_H
...
extern  USBD_DEVICE USR_BULK_desc;
/**
  * @}
  */
...
uint8_t *     USBD_USR_BULK_USRStringDesc (uint8_t speed, uint8_t idx , uint16_t *length);
