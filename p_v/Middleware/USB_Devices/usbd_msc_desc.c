...
{
  USBD_USR_MSC_DeviceDescriptor,
  USBD_USR_MSC_LangIDStrDescriptor,
  USBD_USR_MSC_ManufacturerStrDescriptor,
  USBD_USR_MSC_ProductStrDescriptor,
  USBD_USR_MSC_SerialStrDescriptor,
  USBD_USR_MSC_ConfigStrDescriptor,
  USBD_USR_MSC_InterfaceStrDescriptor,
};
...
*/
uint8_t *  USBD_USR_MSC_DeviceDescriptor( uint8_t speed , uint16_t *length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_MSC_LangIDStrDescriptor( uint8_t speed , uint16_t *length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_MSC_ProductStrDescriptor( uint8_t speed , uint16_t *length)
{
  if(speed == 0)
  {
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_MSC_ManufacturerStrDescriptor( uint8_t speed , uint16_t *length)
{
  USBD_GetString((uint8_t *)(uint8_t *)USBD_MSC_MANUFACTURER_STRING, USBD_StrDesc, length);
  return USBD_StrDesc;
}
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_MSC_SerialStrDescriptor( uint8_t speed , uint16_t *length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_MSC_ConfigStrDescriptor( uint8_t speed , uint16_t *length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_MSC_InterfaceStrDescriptor( uint8_t speed , uint16_t *length)
{
  if(speed == 0)
  {
