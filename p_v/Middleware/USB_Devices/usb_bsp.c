...
#define HAL_OTG_FS_IRQn OTGFS1_IRQn 
#endif
...
void USB_OTG_BSP_Init(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_USB_FS_DM;
  HalDrvGpioIOCtrl(eGPIO_IO_INIT, 0, (char*)&GPIO_InitStructure, sizeof(GPIO_InitStructure), 0);

  GPIO_InitStructure.GPIO_Pin = GPIO_USB_FS_DP;
  HalDrvGpioIOCtrl(eGPIO_IO_INIT, 0, (char*)&GPIO_InitStructure, sizeof(GPIO_InitStructure), 0);
...
void USB_OTG_BSP_EnableInterrupt(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannel = HAL_OTG_FS_IRQn;
