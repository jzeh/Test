...
//#define SYSTEM_CLOCK_180MHz
//#define SYSTEM_CLOCK_168MHz
#define SYSTEM_CLOCK_160MHz
...
#if defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F446xx) || defined(STM32F469_479xx)
#if defined(SYSTEM_CLOCK_180MHz)
  #define PLL_N      360				// --> system clock: 180MHz
#elif defined(SYSTEM_CLOCK_168MHz)
  #define PLL_N      336				// --> system clock: 168MHz
#elif defined(SYSTEM_CLOCK_160MHz)
  #define PLL_N      320				// --> system clock: 160MHz
#endif
...
#if defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F446xx) || defined(STM32F469_479xx)
#if defined(SYSTEM_CLOCK_180MHz)
//	#warning "SYSTEM CLOCK: 180MHz"
  uint32_t SystemCoreClock = 180000000;				// M: 25, N: 360, Q: 7(HCLK를 180MHz로 설정가능하지만, 48MHz가 아닌, 51.428571MHz로 설정된다. USB 오동작 소지 있음, MSC는 동작 하지 않음)
#elif defined(SYSTEM_CLOCK_168MHz)
//	#warning "SYSTEM CLOCK: 168MHz"
  uint32_t SystemCoreClock = 168000000;				// M: 25, N: 336, Q: 7(USB 48MHz)
#elif defined(SYSTEM_CLOCK_160MHz)
  uint32_t SystemCoreClock = 160000000;             // M: 25, N: 320, Q: 7(USB 40MHz)
#endif
#endif /* STM32F427_437x || STM32F429_439xx || STM32F446xx || STM32F469_479xx */
