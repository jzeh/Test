...
static void dma_config(void)
{
  ...
  dmamux_init(DMA2MUX_CHANNEL1, DMAMUX_DMAREQ_ID_ADC2);
  
  /* enable dma transfer complete interrupt */
  dma_interrupt_enable(DMA2_CHANNEL1, DMA_FDT_INT, FALSE);
...
static void adc_config(void)
{
  ...
  adc_ordinary_channel_set(ADC2, ADC_CHANNEL_1, 1, ADC_SAMPLETIME_47_5);
...
//  adc_ordinary_channel_set(ADC2, ADC_CHANNEL_6, 3, ADC_SAMPLETIME_47_5);
  ...
  adc_voltage_monitor_single_channel_select(ADC2, ADC_CHANNEL_1);
