...
//  can_baudrate_struct.bts2_size = CAN_BTS2_3TQ;
  can_baudrate_struct.baudrate_div = 7;
  can_baudrate_struct.rsaw_size = CAN_RSAW_1TQ;
 ...
 */
	...
	uint32_t uiEndMask[14];
			...
			Oem_CAN_Channel_Masket_Set(1, 1/*STANDARD_CAN*/, 8, uiStartMask, uiEndMask);
...
//Oem_CAN_Initial_CH1(Highcan1, eCAN_500KBPS); //init
  Oem_CAN_Initial_CH1(1, 1); //Highcan1, eCAN_500KBPS); //init
Oem_CAN_Channel_Masket_Set(1, 1,1, 0x0700, 0x07FF);
