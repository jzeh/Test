...
/** @addtogroup 435_CAN_communication_mode CAN_communication_mode
  * @{
  */
...
static void can_gpio_config(void)
{
  ...
  gpio_init_struct.gpio_pins = GPIO_PINS_5 | GPIO_PINS_13;
...
//  can_baudrate_struct.bts2_size = CAN_BTS2_3TQ;
  can_baudrate_struct.baudrate_div = 35; // 100K
//  can_baudrate_struct.baudrate_div = 7; // 500K
  can_baudrate_struct.rsaw_size = CAN_RSAW_1TQ;
  can_baudrate_struct.bts1_size = CAN_BTS1_14TQ;
  can_baudrate_struct.bts2_size = CAN_BTS2_5TQ;
 ...
 */
  	uint32_t uiStartMask[14];
	uint32_t uiEndMask[14];
			...
			Oem_CAN_Channel_Masket_Set(2, 1/*STANDARD_CAN*/, 8, uiStartMask, uiEndMask);
...
//  Oem_CAN_Initial_CH2(3, 1); //Highcan1, eCAN_500KBPS); //init
  
  Oem_CAN_Initial_CH2(4, 4); //LOWCAN, 100K
  
Oem_CAN_Channel_Masket_Set(2, 1,1, 0x0000, 0x07FF);
