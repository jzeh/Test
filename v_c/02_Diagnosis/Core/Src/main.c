...
/**
  ...
  * @retval int
  */
#define RAM1_HEAP_SIZE ( 390 * 1024 )	//240822 MAX data 425*1024 -> 447*1024(extra data is 35kb -> 57kb)
...
void PeriphCommonClock_Config(void)
{
  ...
  */
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_ADC|RCC_PERIPHCLK_SDMMC
                              |RCC_PERIPHCLK_SPI1|RCC_PERIPHCLK_SPI2|RCC_PERIPHCLK_SPI5
                              |RCC_PERIPHCLK_FDCAN;
  ...
  PeriphClkInitStruct.Spi123ClockSelection = RCC_SPI123CLKSOURCE_PLL;   // PLL1Q=120MHz for HSM SPI1
