...
/*----------------------------------------------------------------------
	Message
----------------------------------------------------------------------*/
typedef enum                // VCI, PC, Server 烹脚 规过
{
	COMM_USB		    = 0 ,
	COMM_UART		    = 1 ,
	COMM_WIFI		    = 2 ,
...
typedef enum				// Main State
{
	...
	eMain_NONE                      = 0,
	eMain_Init                      = 1,
	eMain_LoadFile_RunRepro         = 2,
	eMain_LoadFile_RDBI             = 3,
	eMain_AutoVin                   = 4,
	eMain_Determin_ECU_To_Upgrade   = 5,
	eMain_GET_ECU_SESSION_OPEN_1    = 6,
	eMain_GET_ECU_SESSION_OPEN_2    = 7,
	eMain_GET_ECU_PART_NO           = 8,
	eMain_GET_ECU_SW_VERION         = 9,
	eMain_JUMP_to_ECU_Upgrade       = 10,
	eMain_Run                       = 11,
	eMain_Sleep                     = 12
#else
	eMain_NONE                      = 0 ,
