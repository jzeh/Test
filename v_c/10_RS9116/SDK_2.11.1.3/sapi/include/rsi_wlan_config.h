...
#define CONCURRENT_MODE                 GIT_CONCURRENT_MODE


//! opermode command paramaters
/*=======================================================================*/
//! To set wlan feature select bit map
//#define RSI_FEATURE_BIT_MAP             GIT_FEATURE_BIT_MAP    
#define RSI_FEATURE_BIT_MAP             (FEAT_SECURITY_OPEN)


//! TCP IP BYPASS feature check
#define RSI_TCP_IP_BYPASS               GIT_TCP_IP_BYPASS

//! TCP/IP feature select bitmap for selecting TCP/IP features
//#define RSI_TCP_IP_FEATURE_BIT_MAP		(GIT_TCP_IP_FEATURE_BIT_MAP)
//#define RSI_TCP_IP_FEATURE_BIT_MAP 		(TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_FEAT_DNS_CLIENT | TCP_IP_FEAT_HTTP_CLIENT | TCP_IP_FEAT_EXTENSION_VALID | TCP_IP_FEAT_SSL | TCP_IP_FEAT_LOAD_PUBLIC_PRIVATE_CERTS | TCP_IP_FEAT_LOAD_CERTS_INTO_RAM) //DNS, http, SSL bit setting
#define RSI_TCP_IP_FEATURE_BIT_MAP 		(TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_FEAT_DNS_CLIENT | TCP_IP_FEAT_HTTP_CLIENT | TCP_IP_FEAT_EXTENSION_VALID | TCP_IP_FEAT_SSL | TCP_IP_FEAT_LOAD_CERTS_INTO_RAM | TCP_IP_FEAT_ICMP)

//! To set custom feature select bit map 
//MONI #define RSI_CUSTOM_FEATURE_BIT_MAP      GIT_CUSTOM_FEATURE_BIT_MAP    // FEAT_CUSTOM_FEAT_EXTENTION_VALID, 0
...
#define RSI_EXT_TCPIP_FEATURE_BITMAP       	(EXT_EMB_MQTT_ENABLE | EXT_TCP_IP_DNS_CLIENT_BYPASS ) //DNS bit setting, EXT_TCP_IP_FEAT_SSL_THREE_SOCKETS
...
#define RSI_JOIN_FEAT_BIT_MAP	        GIT_JOIN_FEAT_BIT_MAP 
...
//! To configure security type - RSI_OPEN, RSI_WPA, RSI_WPA2, RSI_WEP
#define RSI_CONFIG_CLIENT_SECURITY_TYPE         RSI_WPA2
//! To configure encryption type - 0(NONE), 1(TKIP), 2(CCMP)
#define RSI_CONFIG_CLIENT_ENCRYPTION_TYPE       2  
//! To configure PSK
#define RSI_CONFIG_CLIENT_PSK                   "redpine_ap"
//! To configure PMK
#define RSI_CONFIG_CLIENT_PMK                   ""
//! Client Network parameters
//! TCP_STACK_USED BIT(0) - IPv4, BIT(1) -IPv6, (BIT(0) | BIT(1)) - Both IPv4 and IPv6
#define RSI_CONFIG_CLIENT_TCP_STACK_USED        BIT(0)
////! Configure IP mode - RSI_STATIC(0), RSI_DHCP(1)
