...
#define BT_PWR_CTRL_DISABLE BIT(2)
//#define BT_EDR_3MBPS_DISABLE BIT(8)
//#define BT_EDR_2MBPS_DISABLE BIT(9)
//#define BT_5_SLOT_PACKETS_DISABLE BIT(10)
//#define BT_3_SLOT_PACKETS_DISABLE BIT(11)
//#define NOISE_FIGURE_ENABLE BIT(12)	//Note! This feature is not supported in the current release 2.10
//#define BT_SNIFF_OFF BIT(13)	//Note! This feature is not supported in the current release 2.10
//!TA based encoder
//#define TA_BASED_ENCODER_ENABLE BIT(14)	//Note! This feature is not supported in the current release 2.10
//! To enable HFP profile
//#define HFP_PROFILE_ENABLE BIT(15)	//Note! This feature is not supported in the current release 2.10
//! To enable A2DP profile
...
//#define A2DP_ACCELERATOR_MODE_ENABLE BIT(25)	//Note! This feature is not supported in the current release 2.10
//#define A2DP_I2SMODE_ENABLE BIT(26)	//Note! This feature is not supported in the current release 2.10
//! To enable Buffer Alignment for Test Mode
#define BT_BLE_CP_BUFF_SIZE BIT(27)	//To get 512 bytes from common pool, need to enable this, else 320 bytes will be fixed
//#define ATT_OVER_CLASSIC_ENABLE BIT(29)	//Note! This feature is not supported in the current release 2.10
//! To bt rf type
