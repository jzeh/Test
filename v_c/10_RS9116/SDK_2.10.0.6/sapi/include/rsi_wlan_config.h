...
#define RSI_TCP_IP_FEATURE_BIT_MAP		(TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_FEAT_DNS_CLIENT | TCP_IP_FEAT_SSL | TCP_IP_FEAT_EXTENSION_VALID | TCP_IP_FEAT_ICMP) //DNS bit setting
...
#define RSI_EXT_TCPIP_FEATURE_BITMAP       	(EXT_EMB_MQTT_ENABLE | EXT_TCP_IP_DNS_CLIENT_BYPASS) //DNS bit setting
