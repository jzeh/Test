...
int32_t rsi_recvfrom(int32_t sockID,
                     ...
                     int32_t *fromAddrLen);
extern int32_t rsi_recv(int32_t sockID, void *rcvBuffer, int32_t bufferLength, int32_t flags);
int32_t rsi_sendto(int32_t sockID,
                   ...
                   int32_t destAddrLen);
extern int32_t rsi_send(int32_t sockID, const int8_t *msg, int32_t msgLength, int32_t flags);
