...
//#define NOISE_FIGURE_ENABLE BIT(12)	//Note! This feature is not supported in the current release 2.9.1
//#define BT_SNIFF_OFF BIT(13)	//Note! This feature is not supported in the current release 2.9.1
//!TA based encoder
//#define TA_BASED_ENCODER_ENABLE BIT(14)	//Note! This feature is not supported in the current release 2.9.1
//! To enable HFP profile
//#define HFP_PROFILE_ENABLE BIT(15)	//Note! This feature is not supported in the current release 2.9.1
//! To enable A2DP profile
...
//#define A2DP_ACCELERATOR_MODE_ENABLE BIT(25)	//Note! This feature is not supported in the current release 2.9.1
//#define A2DP_I2SMODE_ENABLE BIT(26)	//Note! This feature is not supported in the current release 2.9.1
//! To enable Buffer Alignment for Test Mode
#define BT_BLE_CP_BUFF_SIZE BIT(27)
//#define ATT_OVER_CLASSIC_ENABLE BIT(29)	//Note! This feature is not supported in the current release 2.9.1
//! To bt rf type
