...
// #define AIM_DIR_Pin GPIO_PIN_14  //REAL PIN
// #define AIM_DIR_GPIO_Port GPIOD
#define AIM_DIR_Pin GPIO_PIN_7  // TEST PIN
#define AIM_DIR_GPIO_Port GPIOA
...
/* BLE Module GPIO Control */
#define BT_RSTN_Pin         GPIO_PIN_4
#define BT_RSTN_GPIO_Port   GPIOA
#define BT_STATUS_Pin       GPIO_PIN_5
