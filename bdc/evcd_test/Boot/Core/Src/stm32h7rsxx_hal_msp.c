...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PeriphClkInit.Usart234578ClockSelection = RCC_USART234578CLKSOURCE_HSI;
    ...
    PE8     ------> UART7_TX
    */
    GPIO_InitStruct.Pin = DEBUG_UART7_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_UART7;
    HAL_GPIO_Init(DEBUG_UART7_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = DEBUG_UART7_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_UART7;
    HAL_GPIO_Init(DEBUG_UART7_TX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==UART7)
  {
    ...
    PE8     ------> UART7_TX
    */
    HAL_GPIO_DeInit(DEBUG_UART7_RX_GPIO_Port, DEBUG_UART7_RX_Pin);

    HAL_GPIO_DeInit(DEBUG_UART7_TX_GPIO_Port, DEBUG_UART7_TX_Pin);
